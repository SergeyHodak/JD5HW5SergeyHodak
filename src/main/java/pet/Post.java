...
public class Post {
    ...
    private static final String PET_CLASS_URL = "/v2/pet/";
    ...
    public Post(String resourceUrl){
        RESOURCE_URL = resourceUrl;
    }

    public static void main(String[] args) {
        String resourceUrl = "https://petstore.swagger.io";
        Post post = new Post(resourceUrl);
    ...
    public ApiResponse uploadImage(long id, String additionalMetadata, File file) {
        try {
            ...
            URL url = new URL(RESOURCE_URL + PET_CLASS_URL + id + POST_UPLOAD_IMAGE);
